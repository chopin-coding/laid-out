...
MIGRATION_MODULES = {"sites": "laid_out.contrib.sites.migrations"}
...
# django-vite
# ------------------------------------------------------------------------------
DJANGO_VITE_ASSETS_PATH = APPS_DIR / "static" / "dist"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "laid_out.users.context_processors.allauth_settings",
            ],
        },
    }
]
...
ADMINS = [("""chopin""", "support@thelaidoutproject.org")]
...
#     "TITLE": "laid-out API",
#     "DESCRIPTION": "Documentation of API endpoints of laid-out",
#     "VERSION": "1.0.0",
