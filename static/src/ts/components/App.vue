...
<template>
  <div class="mx-auto px-2 sm:px-6">
    <div class="flex h-full flex-col items-center sm:flex-row">
      <!--  Tree List  -->
      <div class="sm:w-44 px-3 py-2 mt-9
                        rounded-md shadow-lg ring-1 ring-primary ring-opacity-5
                        focus:outline-none">
      ...
      <div>
        <div class="flex flex-col">
          ...
          <div class="px-3 py-2 text-textblackdim">
            <span v-show="!loggedIn">
              <svg
                class="h-5 w-5 fill-textblackdim"
